<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMain.Master" AutoEventWireup="true" CodeBehind="Klinik.aspx.cs" Inherits="_031_Bootstrap_Hastane_Deneme.admin.Klinik" %>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-footer">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList CssClass="form-control" ID="dropListHastane" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1" class="control-label col-sm-2">Klinik</label>
                    <div class="col-sm-10">
                        <asp:TextBox CssClass="form-control" ID="textboxKlinik" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
