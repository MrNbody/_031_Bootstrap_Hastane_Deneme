<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giris.aspx.cs" Inherits="_031_Bootstrap_Hastane_Deneme.admin.Giris" %>
            ...
            <asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="col-sm-2 control-label">Kullanıcı Adı</label>
                        <div class="col-sm-10">
                            <asp:TextBox CssClass="form-control" ID="textboxKullaniciAdi" placeholder="Kullanıcı Adı" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
